        ...
        <div class="Modern-Slider">
          ...
          <div class="item" style="background-image: url('assets/images/slider-image-1-1920x900.jpg');">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <a href="jobs.php" class="filled-button">Service</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="item" style="background-image: url('assets/images/slider-image-1-1920x900.jpg');">
            <div class="img-fill">
                <div class="text-content">
                  ...
                  <h4>for all sectors and platforms.</h4>
                  <p>We will focus your brand on gaining trust, interaction and purpose through a truly professional visual creative content strategy. We are ready to be your partner to compete in the digital world. We provide the solutions and expertise used to build and strengthen a customer base. </p>
          ...
          <div class="item" style="background-image: url('assets/images/slider-image-1-1920x900.jpg');">
            <div class="img-fill">
                <div class="text-content">
                  <h6></h6>
                  <h4>Increase your Visual Content <br> Skill with our Blog </h4>
                  <p>Visuals are a powerful marketing tool today, because well-optimized visual content is better than hundreds-word articles. </p>
                  <a href="blog.php" class="filled-button">Blog</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                ...
                <p>Will build your brand into an identity system that will enhance your brand reputation and differentiate you from the competition. </p>
          ...
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                ...
                <p>We think ahead and create beautiful brand and product photography that becomes part of your digital marketing strategy.</p>
          ...
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                ...
                <p>We can make print designs for you such as flyers, business cards, brochures, banners, posters, packaging, and more for your brand promotion designs.</p>
